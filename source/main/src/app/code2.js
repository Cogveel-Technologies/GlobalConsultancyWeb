    ...
    <div class="content-block">
        ...
        <div class="row clearfix">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="body">
                        <form class="m-4" [formGroup]="searchForm"
                            (ngSubmit)="onSubmit()">
                            <div class="row">
                                <!-- Country Autocomplete -->
                                <div
                                    class="col-xl-2 col-lg-6 col-md-12 col-sm-12 mb-3">
                                ...
                                <div
                                    class="col-xl-2 col-lg-6 col-md-12 col-sm-12">
                ...
                <mat-card class="mat-elevation-z8 full-width-card">
                    <mat-card-header class="header">
                        ...
                        <div>
                            <mat-card-title class="title">{{
                                element.instituteName }}</mat-card-title>
                            <mat-card-subtitle class="subtitle">{{
                                element.programName }}</mat-card-subtitle>
                    ...
                    <mat-card-content class="content">
                        ...
                        <div class="fees-container">
                            ...
                            <p><strong>Province:</strong> {{ element.province
                                }}</p>
                            <p><strong>Year Established:</strong> {{
                                element.yearEstablished | date:'yyyy' }}</p>
                        </div>
                        <div class="fees-container">
                            <p><strong>Duration:</strong> {{ element.duration
                                }}</p>
                            <p><strong>Application Fee:</strong> ${{
                                element.applicationFee }}</p>
                    ...
                    <mat-card-footer class="footer">
                        <small><strong>About Institute:</strong> {{
                            element.aboutInstitute }}</small>
